...
<body>
    ...
    <div class="container-fluid ">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
          ...
          <li class="nav-item">
            <a class="nav-link " id="navbar2" aria-current="page" href="#">Completed Work</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " id="navbar2" aria-current="page" href="#">Histroy</a>
          </li>
  ...
  <center>
   ...
   <h2 style="margin-top: 40px;">All Bookings </h2>
