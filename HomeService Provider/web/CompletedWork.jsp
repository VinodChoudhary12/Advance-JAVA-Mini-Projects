...
<body>
    ...
    <div class="container-fluid ">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
          ...
          <li class="nav-item">
            <a class="nav-link " id="navbar2" aria-current="page" href="Histroy.jsp">Histroy</a>
          </li>
  ...
  <center>
      ...
      <h2 style="margin-top: 40px;">Completed Work</h2>
...
<table class="table w-75 table table-hover" align="center" >
  <thead>
    <tr>
      <th scope="col">SNo.</th>
