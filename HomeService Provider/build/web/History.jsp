    ...
    <div class="container-fluid ">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
            ...
            <li class="nav-item">
                <a class="nav-link " id="navbar2" aria-current="page" href="VendorHomePage.jsp">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " id="navbar2" aria-current="page" href="#">Profile</a>
            </li>
          <li class="nav-item">
            <a class="nav-link " id="navbar2" aria-current="page" href="VendorHomePage.jsp">Booking</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " id="navbar2" aria-current="page" href="CompletedWork.jsp">Completed Work</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" id="navbar2" aria-current="page" href="Histroy.jsp">Histroy</a>
          </li>
...
<table class="table table table-hover" align="center">
  ...
  <div class="container mt-5">
    <h2>
      ...
      <div class="row row-cols-lg-5 row-cols-md-2 row-cols-sm-2 row-cols-1 ">
        
        <div class="col"><img id="img1" class="img-fluid ms-1 " src="https://d27vg8jo26ejl7.cloudfront.net/images/why_joboy/On-Demand-Scheduled.webp" alt=""><p class="p-1 mt-2">ON DEMAND /
          SCHEDULED</p></div>
  ...
  <footer class="text-center text-lg-start bg-light text-muted">
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bxyzm">
      <!-- Left -->
