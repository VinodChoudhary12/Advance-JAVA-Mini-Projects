    ...
    <body>
        <nav>
            <div class="nav-content">
                <div class="logo">
                    <a href="#">Welcome <%= rs.getString(2) %></a>
                </div>
                <ul class="nav-links">
                    <li><a href="#">Home</a></li>
...
<% }else { response.sendRedirect(request.getContextPath() + "/Lopage.jsp"); }
%> <% 
...
String idpass ="root";
          Connection con;
            ...
            try {
                ...
                sql = "UPDATE opration SET name =  ?,fname =  ?,email =?, mobile"
                + " =? WHERE  email =  ? ";
...
//                ps.setString(5, request.getParameter("password"));
                ...
                try {
                    ...
                    response.sendRedirect(request.getContextPath() + "/AfterUpdate.jsp");
                        ...
                        response.sendRedirect(request.getContextPath() + "/RegPage.jsp");
                    }
