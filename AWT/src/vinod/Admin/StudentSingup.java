...
import vinod.Singup;
import vinod.Student.StudentLogin;

public class StudentSingup extends javax.swing.JFrame {
...
//            RandomAccessFile raf = new RandomAccessFile(f + "\\LOGIN.txt", "rwd");
    ...
    void CheckData(String usr, String pswd) //throws FileNotFoundException, IOException
    {
        ...
        try {
            ...
            Logger.getLogger(StudentSingup.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public StudentSingup() throws FileNotFoundException {
        this.raf = new RandomAccessFile(f + "\\LOGIN.txt", "rw");
        initComponents();
    }
...
//        countLines();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentSingup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new StudentSingup().setVisible(true);
                } catch (Exception ex) {
//                    Logger.getLogger(StudentSingup.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
