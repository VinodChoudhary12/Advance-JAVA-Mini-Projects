...
import vinod.Admin.StudentSingup;
...
public class StudentLogin extends javax.swing.JFrame {
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try {
            fileinput = new FileInputStream("student.pro");
        ...
        String id = pr.getProperty("User_" + s1 + "_User");

        String pass = jTextField2.getText();

        String pass1 = pr.getProperty("User_" + s1 + "_Password");
        System.out.println(pass1);
        if (pass.equals(pass1) && s1.equals(id)) {
            new StudentRagi().setVisible(true); // Logger.getLogger(StudentLogin.class.getName()).log(Level.SEVERE, null, ex);
            dispose();
        } else {
