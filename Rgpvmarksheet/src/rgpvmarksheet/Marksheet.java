...
public class Marksheet extends javax.swing.JFrame {
    ...
    public void reg() {
        try {
            ...
            String sql = "SELECT * FROM registration WHERE roll = ?";
...
// Process the result set and set UI elements accordingly
            if (resultSet.next()) {
                ...
                mname.setText(resultSet.getString("MotherName"));
                fname.setText(resultSet.getString("FatherName"));
                cou.setText(resultSet.getString("Course"));
                dob.setText(resultSet.getString("DateOfBirth"));
            }
...
// Process the result set and set UI elements accordingly
            if (resultSet.next()) {
                ob1.setText(resultSet.getString("Hindi"));
                ob2.setText(resultSet.getString("English"));
                ob3.setText(resultSet.getString("physics"));
                ob4.setText(resultSet.getString("Chemestry"));
                ob5.setText(resultSet.getString("Maths"));
                int a=Integer.parseInt(ob1.getText());
                int b=Integer.parseInt(ob2.getText());
                int c=Integer.parseInt(ob3.getText());
                int d=Integer.parseInt(ob4.getText());
                int e=Integer.parseInt(ob5.getText());
                int total=0;
                total=a+b+c+d+e;
                tot.setText(total+"");
            }
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(tot, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
