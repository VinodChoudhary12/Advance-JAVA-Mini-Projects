...
//            }
            ...
            out.print("                    <form action='LOginJDBC'>");
            out.print("                        <input id='inputField' type='text' placeholder='Enter your email' name='gmail'>");
            out.print(
                    "                        <input id='inputField' type='password' placeholder='Enter your password' name='password' >");
...
//            -----------------------------------------------------------------
            ...
            out.print("                        <span class='signup'>Don't have an account?       <a href='Registration'>SignUp</a>");
            out.print("                        </span>");
            out.print("                    </div>");
            out.print("                </div>");
            out.print("            </div>");
