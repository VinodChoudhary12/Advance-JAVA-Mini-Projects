...
<html>
    ...
    <body style="background-color: #1BB295;">
        <form  action='UserRegistration' style='margin-top: 50px '  >
                ...
                <table >  
                    ...
                    <tr>  
                        <td>  
                            ...
                            <span id="four" >Must be 8 character one upparcase,lowercase and number </span>
                        </td>  
                    </tr>  
                    <tr>  
                        <td>  
                    ...
                    <tr>  
                        <td>  
                            ...
                            <a href="User/UserRegistration.jsp">Hii</a>
                        </td>  
                    </tr>  
...
//        }
            ...
            if (password.value.trim() === "") {
                four.innerHTML = "Password is required";
            } else if (!reg.test(password.value)) {
                four.style.color="red";
                four.innerHTML = "Strong Password &#10004;";
                four.innerHTML = "Weak Password &#x2716;";
            } 
